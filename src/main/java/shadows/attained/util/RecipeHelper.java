...
public class RecipeHelper {
	...
	private static final String MODID = AttainedDrops2.MODID;
	private static final String MODNAME = AttainedDrops2.MODNAME;
	public static final List<IRecipe> recipeList = DataLists.RECIPES;
