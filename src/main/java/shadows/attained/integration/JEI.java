...
public class JEI implements IModPlugin {
	...
	public void register(@Nonnull IModRegistry registry) {
		...
		registry.addIngredientInfo(new ItemStack(ModRegistry.ESSENCE), ItemStack.class,
				"jei.attaineddrops2.desc.essence");
		...
		registry.addIngredientInfo(new ItemStack(ModRegistry.SOIL), ItemStack.class,
				"jei.attaineddrops2.desc.vitalized2");
		registry.addIngredientInfo(new ItemStack(ModRegistry.CREATOR), ItemStack.class,
				"jei.attaineddrops2.desc.planter");
	}
